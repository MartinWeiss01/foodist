...
const loadExternalContent = (element, data) => {
    ...
    if(element === 'reviews') {
        let content = "", posted = false, postedID = 0, postedComment = "", postedStars = 0, postedDiv = "";
        if(data.total < 1) document.getElementById(element).innerHTML = `<h1>Recenze</h1><div class="flex hcenter collapsed-content">Zatím nemáme žádnou recenzi!</div>`;
        else {
            ...
            document.getElementById(element).innerHTML = `<h1>Recenze</h1><div class="flex hcenter collapsed-content">${auth ? postedDiv : ''}${content}</div>`;
