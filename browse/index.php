...
<html lang="cs">
    <head>
        ...
        <link rel="stylesheet" href="/assets/css/browse.css" media="none" onload="if(media!='all')media='all'"><noscript><link rel="stylesheet" href="/assets/css/browse.css"></noscript>
                    ...
                    <div class="ddm-menu-parent">
                        ...
                        <div id="menubody" class="flex ddm-menu-body align-right">
                            <?php
                                ...
                                if($account->isLoggedIn()) echo '<a href="#" onclick="showToast(`Not Implemented Yet`)"><div class="flex row hcenter ddm-menu-item"><icon>settings</icon><span>Nastavení</span></div></a><hr class="ddm-menu-divider">';
                            ?>
