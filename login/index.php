<?php
    ...
    $fail = NULL;
    if(isset($_GET["register"])) $fail = "Nyní se můžete přihlásit";
    if(count($_POST) > 0) {
        ...
        if(!$fetched) $fail = "Špatné přihlašovací údaje";
        else {
...
<html lang="cs">
    <head>
        ...
        <script defer src="/assets/js/login.min.js"></script>
    ...
    <body class="flex hcenter vcenter preload">
        <div class="flex root">
            ...
            <form class="flex login" method="post">
                ...
                <button data-role="button" type="submit" id="submitactor" value="Přihlásit se">Přihlásit se</button>
                <small class="reglink"><a href="/register/">Zaregistrovat se</a></small>
            </form>
        </div>
